...
from cosipy.image_deconvolution import RichardsonLucyBasic, RichardsonLucy, RichardsonLucyAdvanced, MAP_RichardsonLucy

def test_RicharsonLucyBasic(dataset, model, mask, tmp_path):
    ...
    algorithm = RichardsonLucyBasic(initial_model = model,
                                    dataset = dataset,
                                    mask = mask,
                                    parameter = parameter)
...
def test_RicharsonLucyAdvanced(dataset, model, mask, tmp_path):
    ...
    # w/ acceleration
    algorithm = RichardsonLucyAdvanced(initial_model = model,
                                       dataset = dataset,
                                       mask = mask,
                                       parameter = parameter)
