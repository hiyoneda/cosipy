...
# import cProfile
# cProfile.run('ori = SpacecraftFile.open(data_path / "20280301_3_month_with_orbital_info.ori")', filename = "prof.prof")
# exit()

ori = SpacecraftFile.open(data_path / "20280301_3_month_with_orbital_info.ori")
