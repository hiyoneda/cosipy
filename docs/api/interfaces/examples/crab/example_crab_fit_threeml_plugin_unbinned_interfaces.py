...
def main():
    ...
    fetch_wasabi_file('COSI-SMEX/DC3/Data/Orientation/DC3_final_530km_3_month_with_slew_15sbins_GalacticEarth_SAA.ori',
                      output=str(data_path / 'DC3_final_530km_3_month_with_slew_15sbins_GalacticEarth_SAA.ori'),
                      checksum='e5e71e3528e39b855b0e4f74a1a2eebe')

    # Download the unbinned Crab data

    # In[5]:


    fetch_wasabi_file('COSI-SMEX/DC3/Data/Sources/crab_standard_3months_unbinned_data_filtered_with_SAAcut.fits.gz', output=str(data_path / 'crab_standard_3months_unbinned_data_filtered_with_SAAcut.fits.gz'), checksum = '1d73e7b9e46e51215738075e91a52632')
    ...
    sc_orientation = SpacecraftHistory.open(data_path / "DC3_final_530km_3_month_with_slew_15sbins_GalacticEarth_SAA.ori")
    ...
    expectation_bkg = bkg.expectation(data, copy = True)
